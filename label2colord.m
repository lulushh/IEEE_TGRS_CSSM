...
switch lower(data_name)
    case 'china'
        map=[0 0 254;254 0 0;0 254 0;254 254 0];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
...
%            map=[0,183,0;0,123,0;0,138,70;0,69,0;169,121,10;0,185,190;120,0,0;217,217,248;120,120,120;200,170,120;220,180,130;96,96,96;184,177,96;0,240,0;203,17,54];
  ...
  case 'sa'
        map=[255 255 153;0 0 255;255 51 0;0 255 153;255 0 255;0 51 204;51 153 255;128 128 0;0 255 0;153 0 153;0 153 204;102 102 153;146 208 80;102 51 0;0 255 204;255 255 0];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
